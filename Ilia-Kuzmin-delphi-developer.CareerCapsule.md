...
=== LANGUAGES ===
English:B2:3yr structured practice with native speaker, A2→B2, technical domain focus|Russian:Native

=== EDUCATION ===
Siberian State University of Telecommunications and Information Technologies (SibSUTIS)|Engineer (5yr)|Software Engineering for Computing and Automated Systems|2001–2006|Thesis: "Comparison and Analysis of Dictionary Data Compression Algorithms" — Excellent. Distinctions in: Computer Graphics, Theory of Computational Complexity, OOP, Operating Systems, Computational Processes Theory, Software Development Technology, Programming in High-Level Languages
...
Chaos→structure superpower:authored Career Capsule LLM methodology, built 10yr site-factory from SEO chaos, designed agentic AI workflows from scratch — same pattern across personal and professional domains across 20yr career
